...
//char s[1000] = {0};
//
//void Java_com_example_CalculatorJNI_jni_CalculatorJNI_setExpression1(JNIEnv *env, jobject jobj, jstring expression) {
...
//}
//
//void Java_com_example_CalculatorJNI_jni_CalculatorJNI_eval1(JNIEnv *env, jobject jobj) {
//    eval(s);
//}
//
//void Java_com_example_CalculatorJNI_jni_CalculatorJNI_formatExpression1(JNIEnv *env, jobject jobj) {
//    formatExpression(s);
//}
//
//void Java_com_example_CalculatorJNI_jni_CalculatorJNI_clearVariable1(JNIEnv *env, jobject jobj) {
//    clearVariables();
//}
//
//jdouble Java_com_example_CalculatorJNI_jni_CalculatorJNI_getAns1(JNIEnv *env, jobject jobj) {
//    return getAns();
//}
//
//void Java_com_example_CalculatorJNI_jni_CalculatorJNI_setVariable1(JNIEnv *env, jobject jobj, jchar c, jdouble d) {
//    setVariable(c, d);
//}